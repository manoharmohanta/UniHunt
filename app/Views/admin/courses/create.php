...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="px-10 py-8 border-b border-slate-100 bg-slate-50/50">
            <h2 class="text-2xl font-bold text-slate-800">Add New Course</h2>
            <p class="text-slate-500 font-medium mt-1">Define educational program details and requirements</p>
        </div>

        <form id="courseForm" action="<?= base_url('admin/courses/store') ?>" method="POST">
            <?= csrf_field() ?>
            <?= honeypot_field() ?>
            ...
            <div class="p-10 space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Course
                                Name</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Program
                                Level</label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Duration
                                (Months)</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Annual
                                Tuition Fee</label>
                            <input type="number" step="0.01" name="tuition_fee"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-50 focus:border-indigo-500 transition-all font-medium"
                                placeholder="0.00">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Total
                                Credits</label>
                    ...
                    <div class="flex items-center gap-6 p-4 bg-slate-50 rounded-xl">
                        <div class="flex items-center gap-3">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="stem" id="stem" value="1" checked class="sr-only peer">
                                <div
                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div id="requirementsLoading"
                            class="hidden animate-spin size-4 border-2 border-indigo-600 border-t-transparent rounded-full">
                        </div>
                    </div>
                    ...
                    <div id="noRequirements"
                        class="hidden col-span-full text-center py-4 text-slate-400 font-medium italic">
                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <button type="button" id="generateAI"
                            ...
                            <span
                                class="hidden animate-spin size-3 border-2 border-white border-t-transparent rounded-full ai-spinner"></span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            <label
                                class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Specific
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="metadata[notes]" id="metadata_notes" rows="3"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-emerald-50 focus:border-emerald-500 transition-all font-medium"
                                placeholder="Summary or important highlights..."></textarea>
                        </div>

                        <div class="md:col-span-2">
                            <label
                                class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Syllabus &
                                Modules</label>
                            <textarea name="metadata[syllabus]" id="metadata_syllabus" rows="3"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-emerald-50 focus:border-emerald-500 transition-all font-medium"
                                placeholder="Key modules and curriculum details..."></textarea>
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Career
                                Outcomes</label>
                            <textarea name="metadata[career_outcomes]" id="metadata_career_outcomes" rows="2"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-emerald-50 focus:border-emerald-500 transition-all font-medium"
                                placeholder="Potential industries and career growth..."></textarea>
                        </div>

                        <div>
                            <label
                                class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Employment
                                Rate</label>
                            <input type="text" name="metadata[employment_rate]" id="metadata_employment_rate"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-emerald-50 focus:border-emerald-500 transition-all font-medium"
                                placeholder="e.g. 95%">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Avg.
                                Starting Salary</label>
                            <input type="text" name="metadata[avg_salary]" id="metadata_avg_salary"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-emerald-50 focus:border-emerald-500 transition-all font-medium"
                                placeholder="e.g. $65,000">
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Top
                                Hiring Roles</label>
                            <input type="text" name="metadata[top_roles]" id="metadata_top_roles"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-emerald-50 focus:border-emerald-500 transition-all font-medium"
                    ...
                    <div class="grid grid-cols-4 md:grid-cols-6 gap-3">
                        ...
                        foreach ($months as $m): ?>
                            <label
                                ...
                                <input type="checkbox" name="intake_months[]" value="<?= $m ?>" class="sr-only peer">
                                <span
                ...
                if (req.type === 'number') {
                    inputHtml = `
                        <div class="relative group">
                            <input type="text" name="metadata[${req.code}]" id="meta_${req.code}"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-50 focus:border-indigo-500 transition-all font-medium"
                    ...
                    inputHtml = `<input type="text" name="metadata[${req.code}]"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-50 focus:border-indigo-500 transition-all font-medium"
