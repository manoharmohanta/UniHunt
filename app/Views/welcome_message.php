...
<body class="bg-background-light dark:bg-background-dark text-text-main dark:text-blue-100 transition-colors duration-300">
    <button onclick="toggleTheme()" class="fixed bottom-4 right-4 p-3 rounded-full bg-primary text-white shadow-lg z-50 hover:bg-primary-hover transition-all">
